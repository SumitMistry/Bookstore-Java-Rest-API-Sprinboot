    ...
    public static void main(String[] args) throws ClassNotFoundException, IOException {
        ...
        System.out.println("> BookStore SpringBoot Application has started...");
            System.out.println(" > Go and explore @Controller http://localhost:8080          and                http://localhost:8080/actuator \n" +
                    ...
                    "       (@RequestParam::    Author_Controller::findAuthBYid1()::    http://localhost:8080/api/bookstore/author/ID?authID=4 \n" +
                    "       (@PathVariable::    Author_Controller::findAuthBYid1()::    http://localhost:8080/api/bookstore/author/ID/4 \n" +
